...
class Bitsloth_LlamaRMSNorm(LlamaRMSNorm):
    def forward(self, X):
...
try:
    ...
    class Bitsloth_MllamaTextRMSNorm(MllamaTextRMSNorm):
        def forward(self, X):
            return fast_rms_layernorm(self, X, gemma = False)
...
def test_rms_layernorm(
    ...
    # from bitsloth.kernels import fast_rms_layernorm
