...
class QuantType(Enum):
    BNB = "bnb"
    BITSLOTH = "bitsloth"  # dynamic 4-bit quantization
    GGUF = "GGUF"
    NONE = "none"
...
BITSLOTH_DYNAMIC_QUANT_TAG = "bitsloth" + "-" + BNB_QUANTIZED_TAG
GGUF_TAG = "GGUF"
BF16_TAG = "bf16"

QUANT_TAG_MAP = {
    QuantType.BNB: BNB_QUANTIZED_TAG,
    QuantType.BITSLOTH: BITSLOTH_DYNAMIC_QUANT_TAG,
...
# NOTE: models registered with org="bitsloth" and QUANT_TYPE.NONE are aliases of QUANT_TYPE.BITSLOTH
@dataclass
class ModelInfo:
    org: str
    base_name: str
    ...
    for size in model_sizes:
        for instruct_tag in instruct_tags:
            ...
            for quant_type in _quant_types:
                # NOTE: models registered with org="bitsloth" and QUANT_TYPE.NONE are aliases of QUANT_TYPE.BITSLOTH
                _org = "bitsloth"  # bitsloth models -- these are all quantized versions of the original model
                register_model(
