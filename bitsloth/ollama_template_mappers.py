...
OLLAMA_TEMPLATE_TO_MODEL_MAPPER = {
    ...
    "phi-3": (
        ...
        bitsloth/Phi-3-mini-4k-instruct-v0-bnb-4bit",
    ...
    "mistral-nemo": (
        bitsloth/Mistral-Nemo-Instruct-2407-bnb-4bit",
    ...
    "starling": (
        bitsloth/Starling-LM-7B-beta-bnb-4bit",
        bitsloth/Starling-LM-7B-beta",
        "Nexusflow/Starling-LM-7B-beta",
    ),
    "yi-chat": (
        bitsloth/yi-34b-chat-bnb-4bit",
        "01-ai/Yi-6B-Chat",
        "01-ai/Yi-34B-Chat",
    ),
    "granite-32": (
