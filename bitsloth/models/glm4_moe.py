...
# Import the grouped gemm utilities from bitsloth kernels
...
class FastGLM47Model(FastLlamaModel):
    ...
    def pre_patch():
        if not HAS_GLM4_MOE:
            raise ImportError(
                "Bitsloth: GLM4 MoE Lite support requires transformers >= 5.0.0. "
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        kwargs.pop("bitsloth_force_compile", None)
