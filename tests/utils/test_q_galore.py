...
#
# Tests for Q-GaLore integration (bitsloth/optimizers/).
...
# Direct import of the actual modules (avoids bitsloth/__init__.py)
...
# Load projector module first (no dependencies on bitsloth)
...
class TestQGaLoreIntegration:
    ...
    def test_weight_quant_activates_on_first_step(self):
        ...
        _adamw_mod_local = sys.modules["bitsloth.optimizers.q_galore_adamw"]
    ...
    def test_params_float_after_weight_quant_step(self):
        ...
        _adamw_mod_local = sys.modules["bitsloth.optimizers.q_galore_adamw"]
        _projector_mod_local = sys.modules["bitsloth.optimizers.q_galore_projector"]
