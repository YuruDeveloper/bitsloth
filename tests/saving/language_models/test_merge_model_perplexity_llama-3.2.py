...
def load_and_compute_8bit_ppl(result_queue, load_in_4bit = False, load_in_8bit = False):
    ...
    merged_model, merged_tokenizer = FastLanguageModel.from_pretrained(
        model_name = "./bitsloth_out/merged_llama_text_model",
        max_seq_length = 2048,
...
if __name__ == "__main__":
    ...
    from bitsloth.chat_templates import standardize_sharegpt
    ...
    model.save_pretrained_merged(
        save_directory = "./bitsloth_out/merged_llama_text_model", tokenizer = tokenizer
    )
