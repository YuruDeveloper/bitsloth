...
class TestGetModelName(unittest.TestCase):
    ...
    def test_resolution_matrix(self):
        cases = [
            ...
            ("Qwen/Qwen3-8B", True, unsloth/Qwen3-8B-bitsloth-bnb-4bit", True),
            ("Qwen/Qwen3-8B", False, unsloth/Qwen3-8B", True),
            ("Qwen/Qwen3-8B-FP8", False, unsloth/Qwen3-8B-FP8", True),
            ("Qwen/Qwen3-8B-FP8", True, unsloth/Qwen3-8B-bitsloth-bnb-4bit", True),
            (
            ...
            ("openai/gpt-oss-20b", True, unsloth/gpt-oss-20b-bitsloth-bnb-4bit", True),
            (unsloth/gpt-oss-20b", True, unsloth/gpt-oss-20b-bitsloth-bnb-4bit", True),
    ...
    def test_static_mapper_contract(self):
        contracts = [
            ("qwen/qwen3-8b", unsloth/qwen3-8b-bitsloth-bnb-4bit"),
            ("qwen/qwen3-8b-fp8", unsloth/qwen3-8b-bitsloth-bnb-4bit"),
            (
                "mistralai/ministral-3-3b-instruct-2512",
                unsloth/ministral-3-3b-instruct-2512-bitsloth-bnb-4bit",
            ),
        ...
        self.assertEqual(
            MAP_TO_BITSLOTH_16bit["qwen/qwen3-8b-fp8"], unsloth/Qwen3-8B-FP8"
        )
